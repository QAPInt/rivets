  ...
  Rivets.ComponentBinding = (function(_super) {
    ...
    ComponentBinding.prototype.bind = function() {
      ...
      if (this.componentView != null) {
        ...
        /*------------qap code-------------------*/
      	// var elContent = this.el.children[0];

        var tempWrapper = document.createElement('div');

        Array.prototype.slice.call(this.el.children, 0).forEach(function(item){
        ...
        this.componentView = new Rivets.View(this.el.children[0], scope, options);
        this.componentView.bind();

        /*------------qap code-------------------*/

        var contentView = new Rivets.View(tempWrapper, this.view.models, options);
        contentView.bind();
        var cusromContent =  this.el.getElementsByTagName('content')[0];

        Array.prototype.slice.call(tempWrapper.children, 0).forEach(function(item){
          cusromContent.appendChild(item);
        });

        // this.el.getElementsByTagName('content')[0].appendChild(tempWrapper);
